     ...
     <div className='w-[82%] h-[100%] flex items-center justify-start overflow-x-hidden absolute right-0 bottom-[5%]'>
      ...
      <div className='w-[80%] h-[130px] flex items-start justify-center flex-col mt-[20px] gap-[10px]'>
        ...
        <div className='w-[100%] h-[100%] flex items-center justify-start'>
            <label htmlFor="image1" className='w-[90px] h-[90px] md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#46d1f7]'>
             ...
             <label htmlFor="image2" className='w-[90px] h-[90px] md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#46d1f7]'>
             ...
             <label htmlFor="image3" className='w-[90px] h-[90px] md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#46d1f7]'>
             ...
             <label htmlFor="image4" className='w-[90px] h-[90px] md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#46d1f7]'>
      ...
      <div className='w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px]'>
        ...
        <input type="text" placeholder='type here' className='w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-[2px] cusor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]'onChange={(e)=>setName(e.target.value)} value={name} required/>
      </div>
        ...
        <textarea type="text" placeholder='type here' className='w-[600px] max-w-[98%] py-[10px] h-[100px] rounded-lg hover:border-[#46d1f7] border-[2px] cusor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]'onChange={(e)=>setDescription(e.target.value)} value={description} required />
      </div>


      <div className='w-[80%] flex items-center gap-[10px] flex-wrap'>
        <div className='md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]'>
          <p className='text-[20px] md:text-[25px] front-semibold w-[100%]'>
            product category
          </p>
       ...
       <div className='w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px]'>
        ...
        <input type="Number" placeholder='₹ 2000' className='w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-[2px] cusor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]' onChange={(e)=>setPrice(e.target.value)} value={price} required/>
      </div>
         ...
         <div className='w-[80%] h-[220px] md:h-[100px] flex items-start justify-center flex-col gap-[10px] py-[10px] md:py-[0px]'>
          ...
          <div className='w-[80%] flex items-center justify-start gap-[10px] mt-[20px]'>
              <input type="checkbox" id='checkbox' className='w-[25px] h-[25px] cursor-pointer'onClick={()=>setBestseller(prev=>!prev)}/>
               <label htmlFor="checkbox" className='text-[18px] md:text-[22px] font-semibold cursor-pointer'>
                 Add to BestSeller
               </label>
             </div>
