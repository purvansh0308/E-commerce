...
function Login() {
  ...
  return (
    <div className=' w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start'>
        <div className='w-[100%] h-[70px] flex items-center justify-start px-[30px] gap-[10px] cursor-pointer' >
        ...
        <div className='max-w-[600px] w-[90%] h-[400px] bg-[#00000025] border-[1px] border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center'>
          <form action=""onSubmit={adminLogin} className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
            <div className='w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px] relative'>
              ...
              { !show && <FaRegEye className='bottom-[50%] w-[20px] h-[20px] cursor-pointer absolute right-[5%]' onClick={()=>{setShow(prev=>!prev)}}/>}
              {show && <FaEyeSlash className='bottom-[50%] w-[20px] h-[20px] cursor-pointer absolute right-[5%]'onClick={()=>{setShow(prev=>!prev)}}/>}
